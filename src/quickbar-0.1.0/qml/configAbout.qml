        ...
        RowLayout {
            ...
            Row {
                ...
                QQC2.Button {
                    ...
                    text: i18nc("@action:button Send an email", "Send an email to %1", modelData.emailAddress)
                ...
                QQC2.Button {
                    ...
                    icon.name: "globe"
                    display: QQC2.AbstractButton.IconOnly
                    text: i18nc("@action:button Open website", "Open website %1", modelData.webAddress)
                    QQC2.ToolTip.delay: Kirigami.Units.toolTipDelay
                    QQC2.ToolTip.visible: hovered
    ...
    Item {
        ...
        ColumnLayout {
            ...
            Kirigami.Heading {
                ...
                text: i18nc("@title:group", "Website")
                textFormat: Text.PlainText
            }
            Kirigami.UrlButton {
            ...
            Kirigami.Heading {
                Layout.topMargin: column.headingTopSpacing
                text: i18nc("@title:group", "Get Help")
                textFormat: Text.PlainText
            }
            Kirigami.UrlButton {
                Layout.leftMargin: column.dataLeftSpacing
                ...
                text: i18nc("@action:button Report an issue", "Report an issue")
                visible: page.metaData.bugReportUrl.length > 0
            }

            Kirigami.Heading {
                Layout.topMargin: column.headingTopSpacing
                text: i18nc("@title:group", "Copyright")
                textFormat: Text.PlainText
            }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    QQC2.Label {
                        Layout.fillWidth: true
                        text: i18nc("@label License", "License: %1", page.metaData.license)
                        textFormat: Text.PlainText
                    }

                    QQC2.Button {
                        icon.name: "view-readermode"
                        text: i18nc("@action:button", "Read License")
                        onClicked: {
            ...
            Kirigami.Heading {
                Layout.fillWidth: true
                Layout.topMargin: column.headingTopSpacing
                text: i18nc("@title:group", "Authors")
                textFormat: Text.PlainText
            ...
            Kirigami.Heading {
                Layout.topMargin: column.headingTopSpacing
                text: i18nc("@title:group", "Credits")
                textFormat: Text.PlainText
            ...
            Kirigami.Heading {
                Layout.topMargin: column.headingTopSpacing
                text: i18nc("@title:group", "Translators")
                textFormat: Text.PlainText
